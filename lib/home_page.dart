  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Row(
          children: const [
            Icon(Icons.map_rounded, color: Color(0xFFFFBCBC)),
            SizedBox(width: 8),
            Text('Bản đồ bạn bè'),
          ],
        ),
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.alt_route, color: Color(0xFFFFBCBC)),
            tooltip: 'Tìm đường',
            onPressed: _showPathSelectionDialog,
          ),
          IconButton(
            icon: const Icon(Icons.group_add, color: Color(0xFFFFBCBC)),
            tooltip: 'Quản lý bạn bè',
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const FriendsManagementPage())),
          ),
          IconButton(
            icon: const Icon(Icons.person, color: Color(0xFFFFBCBC)),
            tooltip: 'Hồ sơ',
      ...
      children: [
        FlutterMap(
          ...
          children: [
            ...
            PolylineLayer(
              polylines: [Polyline(points: _routePoints, strokeWidth: 4, color: Color(0xFFB5EAEA))],
            ),
            MarkerLayer(
              markers: [
                ...
                ...friends.where((f) => f.location != null).map(
                    ...
                    child: Tooltip(
                      message: friend.name,
                      child: const Icon(Icons.location_on, color: Color(0xFFFFBCBC), size: 35),
                    ),
                  ),
                ),
                ...
                Marker(
                  ...
                  width: 40,
                  height: 40,
                  child: const Icon(Icons.my_location, color: Color(0xFFB5EAEA), size: 30),
                ),
              ],
            ),
          ],
        ...
        Positioned(
          ...
          child: FloatingActionButton(
            ...
            child: const Icon(Icons.my_location, color: Color(0xFF393E46)),
          ),
        ),
        if (_isLoadingRoute)
          Container(

  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          children: const [
            Icon(Icons.face_retouching_natural, color: Color(0xFFFFBCBC)),
            SizedBox(width: 8),
            Text('Trang cá nhân'),
          ],
        ),
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.logout, color: Color(0xFFFFBCBC)),
            onPressed: _logout,
            tooltip: 'Đăng xuất',
          ),
        ],
            ...
            if (!_showPasswordForm) ...[
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  icon: const Icon(Icons.lock, color: Color(0xFFFFBCBC)),
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    side: const BorderSide(color: Color(0xFFB5EAEA)),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(16),
                    ),
                  ),
            ...
            if (_showPasswordForm) ...[
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    icon: Icon(_obscureCurrentPassword
                        ...
                        : Icons.visibility, color: Color(0xFFB5EAEA)),
                    onPressed: () => setState(() {
              ...
              Row(
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      icon: const Icon(Icons.check_circle, color: Color(0xFFFFBCBC)),
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      icon: const Icon(Icons.cancel, color: Color(0xFFFFBCBC)),
